...
async function main() {
  console.log("Searching LA & San Diego for golf simulator businesses...\n")
  ...
  for (const p of verified) {
    ...
    await db.tool.create({
      data: {
        ...
        description: `${p.displayName.text} offers golf simulator experiences in the ${addr.city || "Southern California"} area.`,
        tagline: `Golf simulator in ${addr.city || "SoCal"}, ${addr.state || "CA"}`,
        content: "",
  ...
  // Output the new listings for enrichment
